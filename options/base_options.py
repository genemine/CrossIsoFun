...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--input_nA', type=int, default=1735, help='# of input image channels')
        self.parser.add_argument('--input_nB', type=int, default=3072, help='# of input image channels')
        self.parser.add_argument('--input_nC', type=int, default=19303, help='# of input image channels')
        self.parser.add_argument('--output_nc', type=int, default=1, help='# of output image channels')
        self.parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        self.parser.add_argument('--ndf_A', type=int, default=256, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--ndf_B', type=int, default=256, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--ndf_C', type=int, default=128, help='# of discrim filters in first conv layer')
        ...
        self.parser.add_argument('--display_id', type=int, default=1, help='window id of the G display')
